!(function(e, t) {
  ...
  function x(e, t) {
    ...
    return i.replace(D, function(e, t) {
      return t || ('function' == typeof S[e] ? ''.concat(S[e](r, s)) : e);
    });
  }
  function T(e) {
    return (
  ...
  var fe,
    ...
    be = he(
      ...
      void 0,
      {
        ...
        props: {
          ...
          disableYear: { type: Boolean },
          disableMonth: { type: Boolean },
        },
        computed: {
    ...
    we = {
      ...
      props: {
        ...
        disableTableYear: { type: Boolean, default: !1 },
        disableTableMonth: { type: Boolean, default: !1 },
      },
      data: function() {
      ...
      methods: {
        ...
        handelPanelChange: function(e) {
          if (
            !((this.disableTableMonth && 'month' === e) || (this.disableTableYear && 'year' === e))
          ) {
            var t = this.panel;
        ...
        methods: {
          ...
          getMinutesList: function() {
            ...
            return xe(60, this.minuteStep, this.minuteOptions).map(function(t) {
              return { value: new Date(e.date).setMinutes(t), text: Se(t) };
            });
          },
          getSecondsList: function() {
            var e = this;
            return xe(60, this.secondStep, this.secondOptions).map(function(t) {
              return { value: new Date(e.date).setSeconds(t), text: Se(t) };
            });
          },
      ...
      methods: {
        ...
        renderContent: function() {
          var e = this.$createElement,
            ...
            o = this.disableTableMonth ? 'disable-month-selection' : '',
            l = this.disableTableYear ? 'disable-year-selection' : '';
          return e(
            'div',
            {
              class: ''
