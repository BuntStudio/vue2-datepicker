!(function(e, t) {
  ...
  function B(e, t) {
    ...
    try {
      ...
      return (
        void 0 !== h
          ? ((D[6] += 60 * h * 1e3), (m = R.apply(void 0, x(D))))
          : (m = W.apply(void 0, x(D))),
      ...
      void 0,
      {
        ...
        methods: {
          ...
          formatDate: function(e, t) {
            return T(e, t, { locale: this.getLocale().formatLocale });
          },
      ...
      void 0,
      {
        ...
        methods: {
          getHoursList: function() {
            var e = this;
            return Te(this.use12h ? 12 : 24, this.hourStep, this.hourOptions).map(function(t) {
          ...
          getMinutesList: function() {
            var e = this;
            return Te(60, this.minuteStep, this.minuteOptions).map(function(t) {
              return { value: new Date(e.date).setMinutes(t), text: Me(t) };
            });
          },
          getSecondsList: function() {
            var e = this;
            return Te(60, this.secondStep, this.secondOptions).map(function(t) {
        ...
        formatDate: function(e, t) {
          return (
            ...
            'function' == typeof this.getFormatter('stringify')
              ...
              : T(e, t, { locale: this.locale.formatLocale })
          );
        },
