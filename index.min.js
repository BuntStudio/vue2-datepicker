!(function(e, t) {
  ...
  L('Y', I, 'year'),
    ...
    L('MMM', E('monthsShort'), N('monthsShort', 'month')),
    L('MMMM', E('months'), N('months', 'month')),
    L('D', A, 'day'),
    L('DD', $, 'day'),
    L(['H', 'h'], A, 'hour'),
    L(['HH', 'hh'], $, 'hour'),
    ...
    L('d', P, 'weekday'),
    L('dd', E('weekdaysMin'), N('weekdaysMin', 'weekday')),
    L('ddd', E('weekdaysShort'), N('weekdaysShort', 'weekday')),
    L('dddd', E('weekdays'), N('weekdays', 'weekday')),
    L('w', A, 'week'),
    L('ww', $, 'week');
  var ie,
    re = (function(e, t) {
    ...
    we = {
      ...
      methods: {
        ...
        isDisabledMonth: function(e) {
          ...
          return t === n ? e < a : t === i ? e > r : t < n || t > i;
        },
  ...
  var Ye = he(
    ...
    Ae = { default: we, time: _e, datetime: Pe },
    Ie = { default: ke, time: Fe, datetime: $e },
    je = {
      name: 'DatePicker',
      provide: function() {
        var e = this;
